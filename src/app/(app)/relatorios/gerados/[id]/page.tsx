    ...
    <div className="space-y-4">
      ...
      {detalhe.versaoMaisNova && (
        <Link
          ...
          className="flex items-center gap-2 rounded-lg border border-callout-atencao-borda bg-callout-atencao px-4 py-2.5 text-sm text-callout-atencao-texto hover:bg-amber-100 dark:hover:bg-amber-950/60 print:hidden"
        >

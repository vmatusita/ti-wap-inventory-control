...
// convidar, gerar link, editar, status, encerrar sessões, trocar e-mail e apagar conta são
// uma RPC e/ou uma chamada à API de Auth cada, mais a trilha em `eventos_admin`.

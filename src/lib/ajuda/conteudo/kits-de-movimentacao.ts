  ...
  blocos: [
    ...
    { tipo: 'titulo', id: 'kit-passos', texto: 'Criar e aplicar' },
    {
      ...
      itens: [
        ...
        'No rodapé do diálogo, o bloco "Como o kit aplica" mostra ao vivo a frase que o operador vai receber — por exemplo "Saída · Motivo: Novo colaborador · Termo: Gerado · Checklist: Notebook, Monitor". Confira ali antes de salvar, em vez de ir testar no fluxo.',
        'Para fazer um kit parecido com outro: use "Duplicar" na linha dele. O diálogo abre em modo CRIAÇÃO com tudo copiado e o nome já como "Cópia de {nome}" — os nomes são únicos, então repetir o original não passaria. O kit original não é alterado.',
        `Criar e editar kit é de quem abre a Administração — os cargos ${PAPEL_ROTULO.admin} e ${PAPEL_ROTULO.dev} —, porque o cadastro mora lá. APLICAR um kit é de quem registra: o cargo ${PAPEL_ROTULO.operador} usa os kits normalmente, nas filiais dele.`,

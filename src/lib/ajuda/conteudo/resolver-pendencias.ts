...
const DESC_PENDENCIA: Record<TipoPendencia, string> = {
  ...
  // F34 — "devolvido" ficou falso: a triagem não nasce mais da devolução
  // sozinha, e sim de um "Envio para triagem" registrado de propósito.
  triagem:
    'Ativo enviado para triagem parado há mais de 7 dias, aguardando a conferência. Resolve-se registrando a movimentação de triagem (Triagem OK) depois de conferir os acessórios — o botão "Movimentar" da própria linha da fila já abre o registro com o ativo selecionado.',
  patrimonio:

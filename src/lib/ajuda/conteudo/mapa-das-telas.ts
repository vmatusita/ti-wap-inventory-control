  ...
  blocos: [
    ...
    { tipo: 'titulo', id: 'teclado', texto: 'Achar tudo pelo teclado' },
    {
      ...
      itens: [
        ...
        'Os atalhos globais são três: N abre uma nova movimentação, ? abre o quadro de atalhos por cima da tela em que você está (com um link para esta documentação) e, na página Itens, L abre o lançamento. Nenhum deles dispara enquanto você digita num campo; o N e o "?" também ficam calados com uma janela de confirmação aberta — o L é a exceção, ele responde mesmo com uma confirmação na tela.',

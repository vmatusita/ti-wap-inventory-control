...
| [`RUNBOOK-BANCO.md`](RUNBOOK-BANCO.md) | Procedimento de migrations, o "gate", rollback, a janela do `drop` de assinatura velha, o rollback da F62 (a cópia de volta primeiro), armadilhas — o anexo A é histórico |
...
| desfazer a F62 | [`RUNBOOK-BANCO.md`](RUNBOOK-BANCO.md), "O rollback da F62" | `supabase/tests/f62_rollback.sql` — sem a cópia de volta, o desligado recupera o cargo |

  ...
  blocos: [
    ...
    { tipo: 'titulo', id: 'gerar', texto: 'Gerar o documento' },
    {
      ...
      itens: [
        ...
        'O diálogo abre com tudo preenchido a partir da movimentação — "Colaborador", "Marca", "Modelo", "Service Tag", "Patrimônio", "Chamado" e a "Data do termo". Celular pede ainda "Nº do telefone", "IMEI", "Pulsus" e "Observação do aparelho".',

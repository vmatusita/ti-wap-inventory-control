...
| F6B | `F6B-melhorias-ux.md` | Melhorias de UX/features: loading, semana default dom–sáb, quebra no resumo, obs no snapshot, seção de itens nas saídas/entradas, confirmar assinatura do termo, corrigir patrimônio, sessões 24h, manual interno — **rodar depois da F6A** |

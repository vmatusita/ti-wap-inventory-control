...
### 10.2 Import de startup por filial na administração (F7, 16/07/2026 · correção na tela: F7B, 17/07/2026 · patrimônio opcional + datas dd/MMM: F7E, 17/07/2026 · facilitadores: F7F, 17/07/2026 · leitura de .xlsx: F7G, 20/07/2026 · compra datada = entrada: F7H, 20/07/2026 · compra de abertura sempre baseline, reverte a F7H: F8, 20/07/2026)

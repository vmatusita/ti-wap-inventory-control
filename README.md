...
- [ ] F4 — carga inicial única via scripts + go-live (cutover em __/__/____) — inclui carga dos saldos de itens a partir da planilha de gestão online. **OS revisada em 15/07/2026** com a verificação da planilha real (anexo `docs/ANALISE-PLANILHA-F4.md`: 7 CSVs por aba, 3 layouts de inventário, reconciliação de estado, De→Para ampliado)

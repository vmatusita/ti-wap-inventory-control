...
type NavItem = { rotulo: string; icone: LucideIcon; adminOnly?: boolean }
...
const ITENS: NavItem[] = [
  ...
  { rotulo: 'Administração', icone: Settings, adminOnly: true },
]

// Navegacao lateral. Na F0 os itens sao placeholders desabilitados;
// as telas chegam nas fases seguintes. 'Administração' so aparece p/ admin.

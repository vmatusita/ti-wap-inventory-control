# F57 — casos-limite do filtro de filial (ANTES)

Gerado por `F57_CASOS=antes npx vitest run src/lib/filtros/casos-limite.test.ts` — calculado, não digitado.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| /ativos · /movimentacoes · /itens · /itens/historico | `abre` | `abre` | `abre` | `abre` | `abre` | `abre` | `abre` | `abre` | `abre` | — | — | — |
| /pendencias | `abre` | `abre` | `abre` | `abre` | `abre` | `abre` | `abre` | `abre` | — | `abre` | — | — |
| /relatorios/gerados | `abre` | `abre` | `abre` | — | `abre` | `abre` | `abre` | `abre` | — | `abre` | `abre` | — |
| /itens/conferencia | `abre` | — | `abre` | — | `abre` | — | `abre` | `abre` | — | — | — | `abre` |

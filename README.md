...
| [`CHANGELOG.md`](CHANGELOG.md) | Histórico das fases entregues (F0→F12) |
| `supabase/migrations/` | **Fonte da verdade do banco** desde a F1 (0001→0043; a `0029` não existe) |

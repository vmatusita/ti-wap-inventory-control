      ...
      itens: [
        ...
        },
        {
          ...
          saida: [
            ...
            'Ao colar uma lista, os duplicados vão para o balde "{patrimônio} — patrimônio duplicado: escolha qual" e nada entra sem a sua escolha. Da próxima vez, cole a service tag na mesma linha (depois de vírgula, ponto e vírgula ou TAB) e o sistema resolve sozinho.',
          ],
        },
      ],
    },

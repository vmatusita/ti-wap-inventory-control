...
-- ============================================================================
-- MN2 (achado da revisão adversarial) — aplicar_movimentacao zera o detentor na baixa
-- ============================================================================
-- Base: corpo VIGENTE (0023). DIFF vs 0023 = SÓ acrescentar 'devolucao_fornecedor' às DUAS
-- listas de zeramento de colaborador_atual/setor_atual (junto de 'descarte'). Motivo: a
-- devolução ao fornecedor é BAIXA, espelho de descartado; sem isto, um ativo que chegou a
-- em_manutencao por AJUSTE (que preserva o detentor) e é devolvido ao fornecedor manteria
-- um "colaborador fantasma" na ficha e na busca — divergência do espelho descartado. O caso
-- feliz (envio_manutencao já zera) não muda. Assinatura idêntica (create or replace puro).

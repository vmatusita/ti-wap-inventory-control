...
// Header do shell REDUZIDO da sessão por senha (OS-F3 3.9.4): marca + rótulo da
// senha + "Sair". Sem sidebar, sem links de operação (ativos/movimentações/admin).
  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b bg-[#111110] px-4 text-white print:hidden">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-semibold">Estoque TI · Relatórios</span>
      </div>

...
src/
  ...
  lib/
    ...
    actions/       # Server Actions (Zod dentro) — inclui termos.ts (F5A) e dev.ts (F22)
    queries/       # leituras tipadas (ativos, movimentacoes, relatorios, itens, termos, dev…)
